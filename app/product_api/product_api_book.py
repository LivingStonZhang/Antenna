...
import datetime,time,sys,os,threading,functools
...
class Product_API:
    ...
    def get_product_details(self,productid):
        ...
        for item in products:
            ...
            #try:
            data.append('\t'.join([asin,title,authors,manufacture,brand,image,sales_rank,availability,product_group,binding,publication_date,release_date,totalNew,isEligibleForPrime,browses_name,description,prime_price,language,review]))
