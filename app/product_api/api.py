...
class AmazonProduct(LXMLWrapper):
    ...
    def artists(self):
        ...
        :return:
            Returns of list of Artists
        """
        result = []
        artists = self._safe_get_element('ItemAttributes.Artist')
    ...
    def actors(self):
        ...
        :return:
            Returns of list of actors
        """
        result = []
        actors = self._safe_get_element('ItemAttributes.Actor')
    ...
    def director(self):
        ...
        Depricated, please use `directors`.
        :return:
            director (string).
        """
    ...
    def directors(self):
        ...
        :return:
            Returns of list of directors
        """
        result = []
        directors = self._safe_get_element('ItemAttributes.Director')
    ...
    def region_code(self):
        ...
        :return:
            RegionCode (string)
        """
        return self._safe_get_element_text('ItemAttributes.RegionCode')		
    def audience_rating(self):
        ...
        """
        return self._safe_get_element_text('ItemAttributes.AudienceRating')
    def nodes(self):
        """AudienceRating.
        ...
        :return:
            AudienceRating (string)
        """
        return self._safe_get_element_text('BrowseNodes.BrowseNode.BrowseNodeId')

    @property
    def LowestNewPrice(self):
        """LowestUsedPrice.
    ...
    @property
    def isEligibleForPrime(self):
        """IsEligibleForPrime.

        :return:
            IsEligibleForPrime (string)
        """
    ...
    def isPreorder(self):
        ...
        :return:
            IsPreorder (string)
        """
        return self._safe_get_element_text('Offers.Offer.OfferListing.IsPreorder')
    ...
    def weight(self):
        ...
        if weight:
            return float(self._safe_get_element_text('ItemAttributes.ItemDimensions.Weight'))/100

    @property
    def package_weight(self):
        weight = self._safe_get_element_text('ItemAttributes.PackageDimensions.Weight')
        if weight:
            return float(self._safe_get_element_text('ItemAttributes.PackageDimensions.Weight'))/100
    ...
    def size(self):
        ...
        :return:
            Title (string)
        """
        return self._safe_get_element_text('ItemAttributes.Size')
    @property
